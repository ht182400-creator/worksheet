...
**版本**: V4.1
**日期**: 2026-07-23
**状态**: 已通过架构师评审（设计层面已落实 §24 建议）
**变更说明**: V3.0 → V4.0 补充架构师深化审查(§24)；V4.0 → V4.1 将 §24 建议反向落实至设计章节（接口 Restful/幂等、OCR 分阶段准确率、order_no→UUID v7+tenant_id、二维码打印分辨率、状态机协同、多租户、OCR 异步化、API 版本化、OpenTelemetry 埋点）
