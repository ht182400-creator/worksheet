...
**版本**: V4.2
**日期**: 2026-07-23
**状态**: 已通过 PRD 场景化评审（落实 7 项产品缺陷）
**变更说明**: V4.1 → V4.2 基于 PRD 场景化评审报告(V1)落实：状态转移矩阵(§4.9/BR-18)、报工撤回与审核(§4.9/M5-12)、在线并发自动合并与角色分离(BR-06修订/BR-22)、大屏断网降级(BR-19/§21 E16/§5)、OCR 整单级处置(BR-20)、打印失败回退(BR-21/M3-02)、离线冲突默认本地优先(BR-06修订/M5-11)
